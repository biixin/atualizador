...
async function api(path, options = {}) {
  const response = await fetch(`/api${path}`, { ...options, headers: { 'Content-Type': 'application/json', ...options.headers }, signal: AbortSignal.timeout(55_000) });
...
export default function App() {
  ...
  const canSave = capabilities?.preferences !== false;
